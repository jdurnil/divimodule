...
Plugin URI:  mytherapistsite.com
Description: divi grid
Version:     1.0.0
Author:      Jay Durnil
Author URI:  mytherapistsite.com
License:     GPL2
License URI: https://www.gnu.org/licenses/gpl-2.0.html
Text Domain: dgr-divigrid
...
if ( ! function_exists( 'dgr_initialize_extension' ) ):
/**
 * Creates the extension's main class instance.
 *
 * @since 1.0.0
 */
function dgr_initialize_extension() {
	require_once plugin_dir_path( __FILE__ ) . 'includes/Divigrid.php';
}
add_action( 'divi_extensions_init', 'dgr_initialize_extension' );
endif;
